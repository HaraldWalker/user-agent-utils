	...
	public static Collection<Object[]> testData() {
		return asList(new Object[][] {
				// Internet explorer 6.0
				{
						...
						Browser.IE6, "6.0", "WINDOWS_XP" },
				{
						"Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; T312461)",
						Browser.IE6, "6.0", "WINDOWS_2000" },
				{
				...
				// Internet explorer 7
				{
						...
						Browser.IE7, "7.0", "WINDOWS_XP" },
				{
						"Mozilla/4.0 (compatible; MSIE 7.0b; Windows NT 6.0 ; .NET CLR 2.0.50215; SL Commerce Client v1.0; Tablet PC 2.0",
						Browser.IE7, "7.0b", "WINDOWS_VISTA" },
				{
						"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 1.1.4322; .NET CLR 2.0.50727)",
						Browser.IE7, "7.0", "WINDOWS_XP" },
				{
						"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; SLCC1; .NET CLR 2.0.50727; .NET CLR 3.0.04506)",
						Browser.IE7, "7.0", "WINDOWS_VISTA" },
				// Internet Explorer 8
				{
				...
				// Internet Explorer 10
				{
						...
						Browser.IE10, "10.0", "WINDOWS_7" },
				{
						"Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)",
						Browser.IE10, "10.0", "WINDOWS_8" },
				// Internet Explorer 11
				{
						"Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko",
						Browser.IE11, "11.0", "WINDOWS_81" },
				// Internet Explorer 5
				{
						"Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 5.0; .NET CLR 1.1.4322)",
						Browser.IE5_5, "5.5", "WINDOWS_2000" },
				{ "Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 5.0)",
						Browser.IE5_5, "5.5", "WINDOWS_2000" },
				{ "Mozilla/4.0 (compatible; MSIE 5.5; Windows 95)",
						Browser.IE5_5, "5.5", "WINDOWS" },
				// IE old
				{ "Mozilla/4.0 (compatible; MSIE 4.01; Windows 95)",
						Browser.IE, "4.01", "WINDOWS" },
				{
						"Mozilla/4.0 (compatible; MSIE 4.0; Windows 95; .NET CLR 1.1.4322; .NET CLR 2.0.50727)",
						Browser.IE, "4.0", "WINDOWS" },
				{ "Mozilla/2.0 (compatible; MSIE 3.03; Windows 3.1)",
						Browser.IE, "3.03", "WINDOWS" } });
	}
