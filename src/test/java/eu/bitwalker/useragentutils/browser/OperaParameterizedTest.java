...
public class OperaParameterizedTest extends AbstractUserAgentParameterizedTest {
	...
	public static Collection<Object[]> testData() {
		return asList(new Object[][] {
				// opera
				{ "Opera/8.0 (Macintosh; PPC Mac OS X; U; en)", Browser.OPERA,
						"8.0", "MAC_OS_X" },
				// opera9
				{ "Opera/9.52 (Windows NT 5.1; U; en)", Browser.OPERA9, "9.52",
						"WINDOWS_XP" },
				{ "Opera/9.20 (Macintosh; Intel Mac OS X; U; en)",
						Browser.OPERA9, "9.20", "MAC_OS_X" },
				// opera10
				{
						"Opera/9.80 (Windows NT 5.2; U; en) Presto/2.2.15 Version/10.10",
						Browser.OPERA10, "10.10", "WINDOWS_XP" },
				{
						"Opera/9.80 (Macintosh; Intel Mac OS X; U; en) Presto/2.6.30 Version/10.61",
						Browser.OPERA10, "10.61", "MAC_OS_X" },
				// opera11
				{
						"Opera/9.80 (Windows NT 6.1; WOW64; U; pt) Presto/2.10.229 Version/11.62",
						Browser.OPERA11, "11.62", "WINDOWS_7" },
				{
						"Opera/9.80 (Windows NT 6.0; U; pl) Presto/2.10.229 Version/11.62",
						Browser.OPERA11, "11.62", "WINDOWS_VISTA" },
				// opera12
				{
						"Opera/9.80 (Windows NT 6.1; U; es-ES) Presto/2.9.181 Version/12.00",
						Browser.OPERA12, "12.00", "WINDOWS_7" },
				{
						"Opera/12.0(Windows NT 5.1;U;en)Presto/22.9.168 Version/12.00",
						Browser.OPERA12, "12.00", "WINDOWS_XP" },
				// opera15
				{
						"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.52 Safari/537.36 OPR/15.0.1147.100",
						Browser.OPERA15, "15.0.1147.100", "WINDOWS_7" },
				// opera16
				{
				...
				// Issue #86
				{
						...
						Browser.OPERA_MOBILE, "28.0.1764.90386", "ANDROID4" }
