...
public class BotParameterizedTest extends AbstractUserAgentParameterizedTest {
	...
	public BotParameterizedTest(String userAgentValue, Browser expectedBrowser,
			String browserVersionExpected, String osExpected) {
	...
	public static Collection<Object[]> testData() {
		return asList(new Object[][] {
						...
						BOT, null, "UNKNOWN" },
				{
						...
						BOT, null, "UNKNOWN" },
				{ "Googlebot-Image/1.0", Browser.BOT, null, "UNKNOWN" },
				{
						...
						BOT, null, "UNKNOWN" },
				{
						...
						Browser.BOT, null, "UNKNOWN" },
				{ "Mediapartners-Google", Browser.BOT, null, "UNKNOWN" },
				{
						...
						Browser.BOT, null, "UNKNOWN" },
				{
						...
						Browser.BOT, null, "UNKNOWN" },
				{ "ThumbSniper (http://thumbsniper.com)", Browser.BOT, null,
						"UNKNOWN" },
				{ "Phantom.js bot", Browser.BOT, null, "UNKNOWN" },
