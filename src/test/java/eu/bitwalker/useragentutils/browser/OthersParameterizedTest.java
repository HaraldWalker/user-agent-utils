	...
	public static Collection<Object[]> testData() {
		return asList(new Object[][] {
						...
						Browser.VIVALDI, "1.0.83.38", "WINDOWS_8" },
				{
						...
						Browser.VIVALDI, "1.0.111.2", "MAC_OS_X" },
				{
						...
						Browser.VIVALDI, "1.0.111.2", "WINDOWS_7" }
